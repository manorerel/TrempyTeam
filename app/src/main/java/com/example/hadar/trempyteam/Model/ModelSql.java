...
import com.example.hadar.trempyteam.MyApplication;
...
public class ModelSql {
    ...
    public ModelSql(){
        trempHelper = new TrempHelper(MyApplication.getAppContext());
        userHelper = new UserHelper(MyApplication.getAppContext());
    }
